...
function setup() {
  ...
  dob2 = new DobbelSteen(225);
  dob3 = new DobbelSteen(425);
}
...
function draw() {
  if (mouseIsPressed) {
    ...
    dob2.teken();
    dob3.teken();
    totaalAantalOgen = dob1.ogen + dob2.ogen + dob3.ogen;
    textAlign(CENTER, CENTER);
    text("Aantal ogen: " + totaalAantalOgen, canvas.width/2, 275);
  }
}